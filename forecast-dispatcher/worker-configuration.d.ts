/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-dispatcher/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastDispatcherEnv forecast-dispatcher/worker-configuration.d.ts` (hash: 60f3a5995f72c3c97ae2c80d524344cc)
