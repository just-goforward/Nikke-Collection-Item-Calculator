/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-dispatcher/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastDispatcherEnv forecast-dispatcher/worker-configuration.d.ts` (hash: b79f1daa83f0dec8c0f580d453218acb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "DISCORD_CHANNEL_ID" | "DISPATCH_ENABLED" | "GITHUB_APP_PRIVATE_KEY" | "DISCORD_BOT_TOKEN">> {}
}
