/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-dispatcher/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastDispatcherEnv forecast-dispatcher/worker-configuration.d.ts` (hash: 561e36e39ffd84a03dcc1585c882f514)
// Runtime types generated with workerd@1.20260903.1 2026-08-22 nodejs_compat
interface __BaseEnv_GeneratedForecastDispatcherEnv {
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_GeneratedForecastDispatcherEnv {}
}
interface GeneratedForecastDispatcherEnv extends __BaseEnv_GeneratedForecastDispatcherEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "DISCORD_CHANNEL_ID" | "DISCORD_ACTIVITY_CHANNEL_ID" | "DISCORD_ALERT_CHANNEL_ID" | "DISCORD_FALLBACK_CHANNEL_ID" | "DISPATCH_ENABLED" | "GITHUB_APP_PRIVATE_KEY" | "DISCORD_BOT_TOKEN">> {}
}
