...
const classes = {
  ...
  resetButton:
    "reset-button self-center justify-self-center !min-h-[34px] border-0 bg-transparent px-0 !text-[11px] !font-medium text-muted underline underline-offset-[3px] transition-[color,transform] duration-[140ms] enabled:hover:text-text-soft enabled:active:translate-y-px",
  outcomeButton:
    "relative min-h-[44px] overflow-hidden border border-border select-none [touch-action:manipulation] [-webkit-touch-callout:none] [-webkit-user-select:none] [user-select:none]",
