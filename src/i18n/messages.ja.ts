...
export const jaMessages = {
  ...
  "stats.intervalLegend": "半透明領域・サンプル数を反映した95%誤差範囲",
  "stats.intervalRange": "95%誤差範囲 {low}～{high}・標本{attempts}回",
  "stats.intervalRangeAria": "95%誤差範囲は{low}から{high}、標本{attempts}回",
  ...
  "stats.awaiting": "集計待ち",
  "stats.smallSample": "サンプル不足",
  "stats.aboveExpected": "期待値より高い",
  "stats.belowExpected": "期待値より低い",
  "stats.withinExpected": "期待範囲内",
  "stats.sampleHelp1": "サンプルが少ない場合、偶然により結果が高くなったり低くなったりします。",
  "stats.sampleHelp2": "サンプル数を考慮し、結果が動く可能性のある範囲を表示します。",
