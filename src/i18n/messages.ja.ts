...
export const jaMessages = {
  ...
  "staging.forecastWindow": "一時予想獲得量 · 適用期間 {from} ～ {until} KST · {status}",
  "staging.forecastWindowOpenEnded": "一時予想獲得量 · {from} KST以降 · {status}",
  "staging.forecastGain": "青 {blue} / 紫 {purple} / 黄 {yellow}",
  "staging.forecastStatusConfirmed": "日程確定",
  "staging.forecastStatusEstimated": "日程推定",
  ...
  "rights.notice":
    "NIKKEおよび関連する名称、商標、ゲーム内アセットの権利は、各権利者に帰属します。本プロジェクトは非公式のファン制作計算ツールであり、ゲームの開発元またはパブリッシャーとの提携、承認、後援を受けたものではありません。",
