...
export const enMessages = {
  ...
  "stats.intervalLegend": "Translucent area · 95% range adjusted for sample size",
  "stats.intervalRange": "95% range {low}–{high} · {attempts} samples",
  "stats.intervalRangeAria": "95% range from {low} to {high}, based on {attempts} samples",
