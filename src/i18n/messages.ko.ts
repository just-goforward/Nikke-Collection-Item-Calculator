export const koMessages = {
  ...
  "stats.intervalLegend": "반투명 영역 · 표본 수를 반영한 95% 오차 범위",
  "stats.intervalRange": "95% 오차 범위 {low}~{high} · 표본 {attempts}회",
  "stats.intervalRangeAria": "95% 오차 범위 {low}에서 {high}, 표본 {attempts}회",
