...
export const koMessages = {
  ...
  "staging.forecastWindow": "임시 예상 수급 · 적용 기간 {from} ~ {until} KST · {status}",
  "staging.forecastWindowOpenEnded": "임시 예상 수급 · {from} KST 이후 · {status}",
  "staging.forecastGain": "파랑 {blue} / 보라 {purple} / 노랑 {yellow}",
  "staging.forecastStatusConfirmed": "일정 확정",
  "staging.forecastStatusEstimated": "일정 추정",
  ...
  "stats.intervalLegend": "반투명 영역 · 시도 수를 반영한 보수적 95% 범위",
  "stats.intervalRange": "보수적 95% 범위 {low}~{high} · 시도 {attempts}회",
  "stats.intervalRangeAria": "보수적 95% 범위 {low}에서 {high}, 시도 {attempts}회",
  "stats.intervalClippedLow": "실제 범위가 표시 영역 왼쪽을 벗어납니다.",
  "stats.intervalClippedHigh": "실제 범위가 표시 영역 오른쪽을 벗어납니다.",
  ...
  "rights.notice":
    "NIKKE 및 관련 명칭·상표·게임 자산의 권리는 각 권리자에게 있습니다. 이 프로젝트는 비공식 팬 제작 계산기이며, 게임 개발사 또는 퍼블리셔와 제휴하거나 이들의 승인·후원을 받지 않았습니다.",
