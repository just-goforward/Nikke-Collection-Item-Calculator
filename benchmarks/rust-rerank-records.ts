...
export function emptyScenarioRecord(
  ...
  return {
    ...base,
    status,
    minEfOutcome: "failure",
    minEfFirstAction: null,
    minEfSuccessProbability: null,
    minEfExpectedCost: null,
    minEfTotalExpectedUses: null,
    minEfNodeCount: null,
    minEfErrorMessage: null,
    candidateCount: 0,
    ...
    a1NodeCount: null,
    a1ErrorMessage: null,
    exactSelectedFirstAction: null,
    exactIntervened: false,
    exactBaselineExpectedCost: null,
    exactSelectedExpectedCost: null,
    exactDeltaVsBaseline: null,
    exactNodeCount: null,
    exactErrorMessage: null,
    mcExactCalibration: null,
    mcExactStandardizedError: null,
    elapsedMs,
    ...overrides,
  };
}
