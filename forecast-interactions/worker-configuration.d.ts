/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-interactions/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastInteractionsEnv forecast-interactions/worker-configuration.d.ts` (hash: 27af2ad32f8404209cc469ec556fccba)
// Runtime types generated with workerd@1.20260903.1 2026-08-22 nodejs_compat
interface __BaseEnv_GeneratedForecastInteractionsEnv {
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_GeneratedForecastInteractionsEnv {}
}
interface GeneratedForecastInteractionsEnv extends __BaseEnv_GeneratedForecastInteractionsEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_SHA" | "DISCORD_PUBLIC_KEY" | "DISCORD_APPLICATION_ID" | "DISCORD_GUILD_ID" | "DISCORD_APPROVER_USER_ID" | "DISCORD_APPROVAL_CHANNEL_ID" | "DISCORD_ALERT_CHANNEL_ID" | "DISCORD_ACTIVITY_CHANNEL_ID" | "PRODUCTION_MUTATIONS_ENABLED">> {}
}
