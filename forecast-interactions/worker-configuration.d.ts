/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-interactions/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastInteractionsEnv forecast-interactions/worker-configuration.d.ts` (hash: edca90f6d57890f2c22fb42ac5723d60)
