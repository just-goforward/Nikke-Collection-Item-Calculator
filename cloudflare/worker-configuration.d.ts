/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedWorkerEnv cloudflare/worker-configuration.d.ts` (hash: 3f32c72b1b91dd28df88c963b2f9ff92)
// Runtime types generated with workerd@1.20260820.1 2026-08-09 
interface __BaseEnv_GeneratedWorkerEnv {
	DB: D1Database;
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_GeneratedWorkerEnv {}
}
interface GeneratedWorkerEnv extends __BaseEnv_GeneratedWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "TURNSTILE_SECRET_KEY" | "RATE_LIMIT_SECRET">> {}
}
