/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedWorkerEnv cloudflare/worker-configuration.d.ts` (hash: 93cf9530c6684e9101ae8cfeb4a64605)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "DEPLOYMENT_SHA" | "TURNSTILE_SECRET_KEY">> {}
}
