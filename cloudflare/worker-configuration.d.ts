/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedWorkerEnv cloudflare/worker-configuration.d.ts` (hash: d91d5c80375415c3ec79af714bfa1d5a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "TURNSTILE_SECRET_KEY">> {}
}
