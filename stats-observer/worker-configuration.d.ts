/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=stats-observer/wrangler.toml --strict-vars=false --env-interface=GeneratedStatsObserverEnv stats-observer/worker-configuration.d.ts` (hash: a30e6dc5d572d0d9d47cb0cb5c5da974)
// Runtime types generated with workerd@1.20260903.1 2026-08-22 
interface __BaseEnv_GeneratedStatsObserverEnv {
	STATS_DB: D1Database;
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_GeneratedStatsObserverEnv {}
}
interface GeneratedStatsObserverEnv extends __BaseEnv_GeneratedStatsObserverEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "DISCORD_ALERT_CHANNEL_ID">> {}
}
