/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-collector/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastCollectorEnv forecast-collector/worker-configuration.d.ts` (hash: 9b528bce7cfe177ba4276dc3714c63b3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "POLL_MODE" | "ADMIN_TOKEN">> {}
}
