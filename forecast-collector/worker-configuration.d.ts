/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-collector/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastCollectorEnv forecast-collector/worker-configuration.d.ts` (hash: 1c82aefaf76ab63c5cbc56b5627bb73f)
// Runtime types generated with workerd@1.20260903.1 2026-08-14 nodejs_compat
interface __BaseEnv_GeneratedForecastCollectorEnv {
	...
	DISCORD_APPROVAL_MODE: string;
	DISCORD_INTERACTION_OWNER: string;
	ADMIN_TOKEN: string;
}
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_GeneratedForecastCollectorEnv {}
}
interface GeneratedForecastCollectorEnv extends __BaseEnv_GeneratedForecastCollectorEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "POLL_MODE" | "COLLECT_ENABLED" | "DISCORD_APPROVAL_MODE" | "DISCORD_INTERACTION_OWNER" | "ADMIN_TOKEN">> {}
}
