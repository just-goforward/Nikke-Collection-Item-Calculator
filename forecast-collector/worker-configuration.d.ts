/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-collector/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastCollectorEnv forecast-collector/worker-configuration.d.ts` (hash: 585d8d669221607e5b3a38b53688773b)
// Runtime types generated with workerd@1.20260820.1 2026-08-14 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "X_AUTOMATION_ENABLED" | "ADMIN_TOKEN">> {}
}
