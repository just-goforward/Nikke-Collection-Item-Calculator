/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=forecast-collector/wrangler.toml --env= --strict-vars=false --env-interface=GeneratedForecastCollectorEnv forecast-collector/worker-configuration.d.ts` (hash: 6f942115868e77517864814d3b587b0d)
// Runtime types generated with workerd@1.20260825.1 2026-08-14 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "POLL_MODE" | "DISCORD_APPROVAL_MODE" | "ADMIN_TOKEN">> {}
}
