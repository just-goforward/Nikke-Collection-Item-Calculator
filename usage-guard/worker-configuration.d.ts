/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=usage-guard/wrangler.toml --strict-vars=false --env-interface=GeneratedUsageGuardEnv usage-guard/worker-configuration.d.ts` (hash: 46c008d5a4cc2eca01c701c9d442ab37)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_GeneratedUsageGuardEnv {
	GUARD_DB: D1Database;
	ENVIRONMENT: string;
	DEPLOY_SHA: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	DISCORD_ALERT_CHANNEL_ID: string;
	CLOUDFLARE_D1_ANALYTICS_TOKEN: string;
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_GeneratedUsageGuardEnv {}
}
interface GeneratedUsageGuardEnv extends __BaseEnv_GeneratedUsageGuardEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEPLOY_SHA" | "CLOUDFLARE_ACCOUNT_ID" | "DISCORD_ALERT_CHANNEL_ID" | "CLOUDFLARE_D1_ANALYTICS_TOKEN" | "CLOUDFLARE_BILLING_READ_TOKEN" | "DISCORD_BOT_TOKEN" | "ADMIN_TOKEN">> {}
}
